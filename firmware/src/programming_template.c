 ...
 * ================================================================================
 *
 * File Name: programming_template.c
 * Author: [Your Name]
 * Purpose: [Brief description of what this file does]
 * 
 * Description:
 * [Detailed description of the functionality implemented in this file]
 *
 * Dependencies:
 * - [List any dependencies or required libraries]
 *
 * Notes:
